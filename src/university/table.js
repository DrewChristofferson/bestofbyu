                        ...
                        props.courses.map((course, index) => (
                            ...
                            <div key={index} className="tableItem" >
                                ...
                                <div className="scoreInfo">                               
                                    ...
                                    <div className={"ratingButtons"}>
                                        <div className={ratings[course.id] === VOTE_DOWN ? CLASS_VOTE_DOWN : CLASS_NO_VOTE_DOWN }  onClick={() => handleRatingClick(course.id, VOTE_DOWN, updateCourseMutation, course.score, course)}>
                    ...
                    <div className="table">
                        {
                            profs.map((professor, index) => (
                                ...
                                <div  className="tableItem" >
                                    <div className="scoreInfo">                               
                                        <div className={"ratingButtons"}>
                                            <div className={ratings[professor.id] === VOTE_UP ? CLASS_VOTE_UP : CLASS_NO_VOTE_UP }  onClick={(event) => handleRatingClick(professor.id, VOTE_UP, updateProfessorMutation, professor.score, professor)}>
                                            <AiIcons.AiFillUpCircle />
                                            </div>
                                        </div>
                                        <div className="scoreDisplay">
