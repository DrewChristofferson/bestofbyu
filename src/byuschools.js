...
import { listSchools, listDepartments, listProfessors } from './graphql/queries';
        ...
        <bs.Container fluid className="min-vh-100 d-flex flex-column" style={{textAlign: "left"}}>
            <Switch>
                <Route path={`${match.path}/:schId/:deptId/:type/:oid`}>
                    <Detail professorsForCourse={professorsForCourse} updateScore={updateScore} getRatings={getRatings} userRatings={userRatings} createRating={createRating} isLoading={isLoadingProfessors}/>
                </Route>
                <Route path="/schools">
                        ...
                        <bs.Col md="9">
                                ...
                                <Switch>
                                    ...
                                    <Route path={`${match.path}/:schId/:deptId`}>
                                        <SchoolTables updateScore={updateScore} getRatings={getRatings} userRatings={userRatings} createRating={createRating} departments={departments} isLoading={isLoadingDepartments}/>
                                    </Route>
