                        ...
                        props.categoryItems.map((catItem, index) => (
                            <div key={index} className="tableItem">
                                ...
                                <div className={"tableItemChildSmall ratingButtons"}>
                                    <div className={catItem.userRating === VOTE_UP ? CLASS_VOTE_UP : CLASS_NO_VOTE } style={{ cursor: "pointer"}} onClick={() => handleRatingClick(catItem.id, VOTE_UP, updateCourseMutation, catItem.score)}>
                                        <FontAwesomeIcon icon={faSortUp}/>
                                    </div>
                                    <div className={catItem.userRating === VOTE_DOWN ? CLASS_VOTE_DOWN : CLASS_NO_VOTE } style={{ cursor: "pointer"}} onClick={() => handleRatingClick(catItem.id, VOTE_DOWN, updateCourseMutation, catItem.score)}>
                                ...
                                <div className={"tableItemChildBig"}>
                                    <div className={"tableItemTitle"}>
                                        <Link to={`${match.url}/${catItem.id}`}>{catItem.name}</Link>
                                    </div>
                                ...
                                {/* <div className={"tableItemChildBig"}>
                                    <div>
                                        <strong>Credits</strong> {": "  + catItem.numCredits}
                                    </div>
                                    <div>
                                        <strong>Department</strong> {": " + catItem.department.name}
                                    </div>
                                    <div>
                                        <strong>College</strong> {": " + catItem.department.school.name}
                                    </div>
                                ...
                                <div className={"tableItemChildSmall"} style={{ cursor: "pointer"}} >
                                    <bs.Dropdown>
                                        ...
                                        <bs.Dropdown.Menu>
                                            <bs.Dropdown.Item href={`${match.url}/${URL_PARAM_COURSES}/${catItem.id}`}>View Details</bs.Dropdown.Item>
