                ...
                professors.map((professor, index) => (
                    <bs.Row style={{paddingTop: "1.5rem", paddingBottom: "1.5rem", borderTop: "2px solid black"}} key={index}>
                        ...
                        <bs.Col style={{fontSize: "2.5rem", paddingTop: ".8rem"}} md="1">
                            <bs.Row className={professor.userRating === VOTE_UP ? CLASS_VOTE_UP : CLASS_NO_VOTE } style={{ cursor: "pointer", paddingLeft: "3rem"}} onClick={() => props.createRating(professor.id, VOTE_UP, updateProfessorMutation, professor.score)}>
                                <FontAwesomeIcon icon={faSortUp}/>
                            </bs.Row>
                            <bs.Row className={professor.userRating === VOTE_DOWN ? CLASS_VOTE_DOWN : CLASS_NO_VOTE } style={{ cursor: "pointer", paddingLeft: "3rem"}} onClick={() => props.createRating(professor.id, VOTE_DOWN, updateProfessorMutation, professor.score)}>
