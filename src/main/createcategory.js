...
function CreateCategory() {
    ...
    let photoClickHandler = (id, link) => {
        ...
        if (id === selected){
            ...
            setSelected(id);
            setFormData({ ...formData, 'imgsrc': link})
        }
        console.log(formData)
    }
            ...
            <div className="testImageContainer">
                {
                    ...
                    photos.map((link, index) => {
                        return(
                            <div id={index} >
                                <img alt="test" src={link} onClick={() => photoClickHandler(index, link)} className={index === selected ? "testImageClicked" : "testImage"}/>
                            </div>
                        )
                    }) 
                    :
